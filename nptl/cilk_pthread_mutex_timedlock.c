...
int
cilk_pthread_mutex_clocklock_common (pthread_mutex_t *mutex,
				  clockid_t clockid,
...
int
cilk_pthread_mutex_clocklock (pthread_mutex_t *mutex,
			   clockid_t clockid,
			   const struct timespec *abstime)
{
  ...
  return cilk_pthread_mutex_clocklock_common (mutex, clockid, abstime);
}

int
cilk_pthread_mutex_timedlock (pthread_mutex_t *mutex,
			   const struct timespec *abstime)
{
  LIBC_PROBE (mutex_timedlock_entry, 2, mutex, abstime);
  return cilk_pthread_mutex_clocklock_common (mutex, CLOCK_REALTIME, abstime);
}
